  ...
  return (
    <Listbox value={selected} onChange={setSelected}>
      <div className="relative mt-1 ">
        <Listbox.Button className="relative cursor-pointer p-3 w-full flex bg-zinc-50 text-zinc-900 shadow-sm border-[1px] border-transparent transition-all active:border-zinc-600 active:border-[1px] hover:border-[1px] border-zinc-200 hover:border-zinc-900  focus:border-[1px] focus-within:shadow-md focus:border-zinc-900 rounded-lg">
